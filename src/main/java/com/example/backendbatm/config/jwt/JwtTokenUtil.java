package com.example.backendbatm.config.jwt;
...
public class JwtTokenUtil implements Serializable {
	...
	private Claims getAllClaimsFromToken(String token) {
		...
		System.out.println(" claims string inside getAllClaimsFromToken is "
	...
	public String generateToken(UserDetails userDetails) {
		...
		else if (userDetails.getAuthorities().contains(new SimpleGrantedAuthority("ROLE_Staff"))) {
